...
(function(global, factory) {
  ...
  var FinancialLinearScale = Chart.scaleService
    ...
    tooltips: {
      ...
      callbacks: {
        label: function(tooltipItem, data) {
          var o =
            data.datasets[tooltipItem.datasetIndex].data[tooltipItem.index].o;
          var h =
            data.datasets[tooltipItem.datasetIndex].data[tooltipItem.index].h;
          var l =
            data.datasets[tooltipItem.datasetIndex].data[tooltipItem.index].l;
          var c =
            data.datasets[tooltipItem.datasetIndex].data[tooltipItem.index].c;
  ...
  globalOpts$1.elements.candlestick = helpers$3.merge({}, [
  ...
  var CandlestickElement = FinancialElement.extend({
    draw: function() {
      ...
      var borderColor;
      if (c < o) {
        borderColor = helpers$3.getValueOrDefault(
          borderColors ? borderColors.up : undefined,
          globalOpts$1.elements.candlestick.borderColor
        );
        ctx.fillStyle = helpers$3.getValueOrDefault(
          vm.color ? vm.color.up : undefined,
        ...
        ctx.fillStyle = helpers$3.getValueOrDefault(
          vm.color ? vm.color.down : undefined,
        ...
        ctx.fillStyle = helpers$3.getValueOrDefault(
          vm.color ? vm.color.unchanged : undefined,
          globalOpts$1.elements.candlestick.color.unchanged
        );
      }

      ctx.lineWidth = helpers$3.getValueOrDefault(
        vm.borderWidth,
        globalOpts$1.elements.candlestick.borderWidth
      );
      ctx.strokeStyle = helpers$3.getValueOrDefault(
        borderColor,
        globalOpts$1.elements.candlestick.borderColor
      );
  ...
  Chart.defaults.candlestick = Chart.helpers.merge(
    {},
    Chart.defaults.financial
  );
  ...
  globalOpts$2.elements.ohlc = helpers$4.merge({}, [
  ...
  var OhlcElement = FinancialElement.extend({
    draw: function() {
      ...
      var l = vm.candleLow;
      var c = vm.candleClose;
      var armLength = helpers$4.getValueOrDefault(
        vm.armLength,
        globalOpts$2.elements.ohlc.armLength
      );
      var armLengthRatio = helpers$4.getValueOrDefault(
        vm.armLengthRatio,
      ...
      if (c < o) {
        ctx.strokeStyle = helpers$4.getValueOrDefault(
          vm.color ? vm.color.up : undefined,
      ...
      ctx.lineWidth = helpers$4.getValueOrDefault(
        vm.lineWidth,
